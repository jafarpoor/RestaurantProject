...
namespace Persistence.Migrations
{
    ...
    [Migration("20221124070852_useraddressinorder1")]
    partial class useraddressinorder1
    {
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 599, DateTimeKind.Local).AddTicks(1962));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 607, DateTimeKind.Local).AddTicks(4178));
            ...
            modelBuilder.Entity("Domain.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 607, DateTimeKind.Local).AddTicks(7103));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 607, DateTimeKind.Local).AddTicks(9192));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 608, DateTimeKind.Local).AddTicks(1200));
            ...
            modelBuilder.Entity("Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 608, DateTimeKind.Local).AddTicks(2917));
            ...
            modelBuilder.Entity("Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 608, DateTimeKind.Local).AddTicks(4796));
            ...
            modelBuilder.Entity("Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 608, DateTimeKind.Local).AddTicks(6662));
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 38, 51, 608, DateTimeKind.Local).AddTicks(9421));
