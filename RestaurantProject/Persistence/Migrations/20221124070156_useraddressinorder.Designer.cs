...
namespace Persistence.Migrations
{
    ...
    [Migration("20221124070156_useraddressinorder")]
    partial class useraddressinorder
    {
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 163, DateTimeKind.Local).AddTicks(3271));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 174, DateTimeKind.Local).AddTicks(7735));
            ...
            modelBuilder.Entity("Domain.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 175, DateTimeKind.Local).AddTicks(9760));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 176, DateTimeKind.Local).AddTicks(3513));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 176, DateTimeKind.Local).AddTicks(8274));
            ...
            modelBuilder.Entity("Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 177, DateTimeKind.Local).AddTicks(3917));
            ...
            modelBuilder.Entity("Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 178, DateTimeKind.Local).AddTicks(2228));
            ...
            modelBuilder.Entity("Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 178, DateTimeKind.Local).AddTicks(7324));
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 24, 10, 31, 55, 179, DateTimeKind.Local).AddTicks(1675));
