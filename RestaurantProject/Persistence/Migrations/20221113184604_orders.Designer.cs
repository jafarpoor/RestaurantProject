...
namespace Persistence.Migrations
{
    ...
    [Migration("20221113184604_orders")]
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 21, DateTimeKind.Local).AddTicks(7344));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 28, DateTimeKind.Local).AddTicks(9841));
            ...
            modelBuilder.Entity("Domain.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 29, DateTimeKind.Local).AddTicks(2380));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 29, DateTimeKind.Local).AddTicks(3973));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 30, DateTimeKind.Local).AddTicks(2846));
            ...
            modelBuilder.Entity("Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 30, DateTimeKind.Local).AddTicks(5824));
            ...
            modelBuilder.Entity("Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 30, DateTimeKind.Local).AddTicks(7470));
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 13, 22, 16, 4, 30, DateTimeKind.Local).AddTicks(9630));
