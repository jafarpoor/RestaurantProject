...
namespace Persistence.Migrations
{
    ...
    [Migration("20221027204220_basket")]
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 28, 0, 12, 19, 787, DateTimeKind.Local).AddTicks(7937));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 28, 0, 12, 19, 795, DateTimeKind.Local).AddTicks(5309));
            ...
            modelBuilder.Entity("Domain.Categories.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 28, 0, 12, 19, 795, DateTimeKind.Local).AddTicks(8144));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 28, 0, 12, 19, 795, DateTimeKind.Local).AddTicks(9772));
            ...
            modelBuilder.Entity("Domain.Categories.CategoryItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 28, 0, 12, 19, 796, DateTimeKind.Local).AddTicks(1946));
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 28, 0, 12, 19, 796, DateTimeKind.Local).AddTicks(4240));
