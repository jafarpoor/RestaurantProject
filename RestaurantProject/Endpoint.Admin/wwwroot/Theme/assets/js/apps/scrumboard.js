                        ...
                        '<div class="task-container-header">'+
                            ...
                            '<div class="dropdown">'+
                                ...
                                '<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-4">'+
                                    '<a class="dropdown-item list-edit" href="javascript:void(0);">ویرایش</a>'+
                                    '<a class="dropdown-item list-delete" href="javascript:void(0);">حذف</a>'+
                                    '<a class="dropdown-item list-clear-all" href="javascript:void(0);">پاک کردن همه</a>'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
