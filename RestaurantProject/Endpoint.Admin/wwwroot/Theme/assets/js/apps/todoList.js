              ...
              '<div class="todo-item-inner">'+
                  ...
                  '<div class="action-dropdown">'+
                      '<div class="dropdown">'+
                          ...
                          '<div class="dropdown-menu" aria-labelledby="dropdownMenuLink-4">'+
                              '<a class="dropdown-item edit" href="javascript:void(0);">ویرایش</a>'+
                              '<a class="important dropdown-item" href="javascript:void(0);">مهم</a>'+
                              '<a class="dropdown-item delete" href="javascript:void(0);">حذف</a>'+
                              '<a class="dropdown-item permanent-delete" href="javascript:void(0);">Permanent حذف</a>'+
...
// Validation Process
  ...
  getTaskTitleInput.addEventListener('input', function() {
      ...
      if (getTaskTitleInputValue == "") {
        $_getValidationField[0].innerHTML = 'عنوان لازم است';
