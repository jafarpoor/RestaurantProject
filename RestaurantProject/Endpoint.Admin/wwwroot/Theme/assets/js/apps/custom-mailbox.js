	...
	*/
	...
	getEmailToInput.addEventListener('input', function() {
	    ...
	    if (getEmailToInputValue == "") {
	      $_getValidationField[0].innerHTML = 'ایمیل مورد نیاز است';
	...
	getSubjectInput.addEventListener('input', function() {
	  ...
	  if (getSubjectInput == "") {
	    $_getValidationField[2].innerHTML = 'موضوع موردنیاز';
		                ...
		                '<div class="mail-content-container sentmail" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >'+
		                    '<div class="d-flex justify-content-between mb-3">'+
	                            ...
	                            '<div class="action-btns">'+
	                                '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="پاسخ">'+
	                                ...
	                                '</a>'+
	                                '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="باز نشر">'+
                                    ...
                                    '<div class="mail-item-inner">' +
                                        ...
                                        '<div class="d-flex">' +
                                            ...
                                            '<div class="f-body" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >' +
                                                ...
                                                '</div>' +
                                                '<div class="meta-title-tag">' +
                                                    "<p class='mail-content-excerpt' data-mailDescription='"+$_textDelta+"'><span class='mail-title' data-mailTitle='"+$_mailSubject+"'>پیش نویس : "+$_mailSubject+" - </span>"+$_mailDescription+"</p>" +
                                                    '<div class="tags">' +
                                                        '<span class="g-dot-primary"></span>' +
                                                        '<span class="g-dot-warning"></span>' +
                                                        '<span class="g-dot-success"></span>' +
	...
	*/
	function $_GET_mailItem_Reply() {
		$(".reply").on('click', function(event) {
		    ...
		    $('#m-to').val($_mailTo);
		    $('#m-cc').val($_mailCC);
		    $('#m-subject').val('پاسخ: ' + $_mailSubject);
			quill.setContents($_mailDescription);
			$('#composeMailModal').modal('show');
		})
	}
	...
	*/
	function $_GET_mailItem_Forward() {
		$(".forward").on('click', function(event) {
		    ...
		    $('#m-to').val($_mailTo);
		    $('#m-cc').val($_mailCC);
		    $('#m-subject').val('ارسال به:  ' + $_mailSubject);
			quill.setContents($_mailDescription);
			$('#composeMailModal').modal('show');
		})
	}
